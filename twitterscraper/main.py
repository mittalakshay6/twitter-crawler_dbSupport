"""
Twitter scraper using command line interface
"""
import csv
import json
import logging
...
import twitterscraper.tweet_html
import twitterscraper.tweet_url
    ...
    try:
        ...
        parser.add_argument("-a", "--all", action='store_true',
                            help="Set this flag if you want to get all tweets "
                                 "in the history of twitter i.e.,  begindate is set to 2006-03-01."
        ...
        # action='store_true':: This means that, if the option is specified, assign the value True to parser.parse_args().csv. Not specifying it implies False.
